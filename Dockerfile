...
RUN \
    apt-get update && \
    apt-get upgrade -y && \
    apt-get install -y procps curl gpg lsb-release socat netcat-openbsd && \
    apt-get install -y tcpdump net-tools bind9-dnsutils iputils-ping inetutils-traceroute && \
    \
